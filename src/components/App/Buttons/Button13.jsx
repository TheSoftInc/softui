      ...
      >
        <div className="flex flex-wrap justify-evenly items-center gap-5">
          ...
          <button className="group relative cursor-pointer align-middle no-underline text-[inherit] p-0 outline-none bg-transparent w-48 h-auto flex items-center">
            <span
              className="group-hover:w-full group-hover:translate-x-1 translate-y-0 group-hover:translate-y-0 group-hover:bg-black transition-all duration-[0.45s] ease-[cubic-bezier(0.65,0,0.076,1)] relative block w-12 h-12 m-0 rounded-[1.625rem] bg-[#1e1f27]"
              aria-hidden="true"
            >
            ...
            <span className="text-gray-500 dark:text-white group-hover:text-white transition-all duration-[0.45s] ease-[cubic-bezier(0.65,0,0.076,1)] absolute  font-bold leading-[1.6] text-center uppercase ml-[1.85rem] mr-0 my-0 px-0 py-3 inset-0">
              Learn More
            </span>
          </button>
        </div>
