...
<button className="cursor-pointer font-semibold overflow-hidden relative z-[1]0 border border-green-500 group px-8 py-1">
  <span className="relative z-[1] text-green-500 group-hover:text-white  duration-500">Hover Me !</span>
...
`}
      >
        <div className="flex flex-wrap space-y-5 md:space-y-0 justify-evenly items-center">
          ...
          <button className="cursor-pointer font-semibold overflow-hidden relative z-[1]0 border border-green-500 group px-8 py-1">
            <span className="relative z-[1] text-green-500 group-hover:text-white  duration-500">
              Hover Me !
            </span>
            <span className="absolute w-full h-full bg-gradient-to-r from-green-700 to-green-200 -left-32 top-0 -rotate-45 group-hover:rotate-0 group-hover:left-0 duration-500" />
            <span className="absolute w-full h-full bg-gradient-to-r from-green-700 to-green-200 -right-32 top-0 -rotate-45 group-hover:rotate-0 group-hover:right-0 duration-500" />
