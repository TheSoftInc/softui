...
<button className="overflow-hidden  py-3 px-6 bg-black text-white border-none rounded-md text-sm font-bold cursor-pointer relative z-[1] group">
  ...
  <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-3 left-7 z-[1]">Explore!</span>
</button>
...
`}
      >
        <div className="flex justify-evenly items-center">
          ...
          <button className="relative px-8 py-2 rounded-md bg-white isolation-auto z-[1] border-2 border-lime-500 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 before:rounded-full  before:bg-lime-500 before:-z-[1]  before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700">
            Hover Me
          </button>
          ...
          <button className="overflow-hidden  py-3 px-6 bg-black text-white border-none rounded-md text-sm font-bold cursor-pointer relative z-[1] group">
            ...
            <span className="absolute w-36 h-32 -top-8 -left-2 bg-indigo-400 rotate-12 transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-left" />
            <span className="absolute w-36 h-32 -top-8 -left-2 bg-indigo-600 rotate-12 transform scale-x-0 group-hover:scale-x-50 transition-transform group-hover:duration-1000 duration-500 origin-left" />
            <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-3 left-7 z-[1]">
              Explore!
            </span>
          </button>
        </div>
